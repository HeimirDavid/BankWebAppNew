...
namespace BankWebApp.Migrations
{
    ...
    [Migration("20220129112036_NewUsers")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BankWebApp.Models.Card", b =>
                {
            ...
            modelBuilder.Entity("BankWebApp.Models.Disposition", b =>
                {
                    b.Property<int>("DispositionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BankWebApp.Models.Loan", b =>
                {
            ...
            modelBuilder.Entity("BankWebApp.Models.PermenentOrder", b =>
                {
            ...
            modelBuilder.Entity("BankWebApp.Models.User", b =>
                {
            ...
            modelBuilder.Entity("BankWebApp.Models.Card", b =>
                {
                    b.HasOne("BankWebApp.Models.Disposition", "Disposition")
                        .WithMany("Cards")
            ...
            modelBuilder.Entity("BankWebApp.Models.Transaction", b =>
                {
                    b.HasOne("BankWebApp.Models.Account", "AccountNavigation")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BankWebApp.Models.User", null)
                        .WithMany()
