...
//        public LoginController(IConfiguration config, UserManager<User> userManager, SignInManager<User> signInManager, BankContext context)
//        {
//            _config = config;
...
//        {
//             Task<User> user = Authenticate(userLogin);
...
//        private async Task<User> Authenticate(User userLogin)
//        {

//            var result = await _signInManager.PasswordSignInAsync(userLogin.Email,
//                            userLogin.PasswordHash, false, lockoutOnFailure: true);
...
//NEXT TRY NOT USING IDENTITY TO LOGIN
